...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveita",sdf.parse("22/02/2018"),new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Otimo dia",sdf.parse("23/02/2018"),new AuthorDTO(alex));
